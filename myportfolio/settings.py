...
SECRET_KEY = 'django-insecure-l7sy8bkkw4$^$49ahjkidvishi+0idqid3_k5)tes$1bvjj3nq'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["jaswinder.pythonanywhere.com","127.0.0.1"]
...
# Simple local-memory cache (for testing)
CACHES = {
    'default': {
